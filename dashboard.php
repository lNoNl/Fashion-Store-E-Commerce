...
// =================================================================
// SECTION B: PHP LOGIC FOR ORDER MANAGEMENT
// =================================================================
$order_results_per_page = 7;
...
// Check if parameters exist before binding
if (!empty($o_params_for_fetch)) {
...
<style>
    /* ปรับให้สวยงาม: เพิ่มขอบสีดำให้กรอบ .detail-card ด้านนอก */
    .detail-card {
...
<div class="container">
    ...
    <!-- NEW: Wrap order section in detail-card for consistent styling -->
    <div class="detail-card">
        <h2 id="orders" class="section-title">จัดการออเดอร์ลูกค้า</h2>
        <div class="controls-panel">
            <div class="status-filters">
                ...
                ?>
                    <a href="dashboard.php?<?= http_build_query($query_params) ?>#orders" class="status-filter-btn <?= $active_class ?>"><?= $label ?></a>
                <?php endforeach; ?>
            </div>
        ...
        <div class="pagination">
            ...
            ?>
                <a href="dashboard.php?<?= http_build_query($query_params) ?>#orders" class="<?= ($page == $order_current_page) ? 'active' : '' ?>"><?= $page ?></a>
            <?php endfor; endif; ?>
        </div>
    </div> <!-- Close detail-card -->
